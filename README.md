...
Branch: CSE  Education Technology
...
task-2-portfolio/ Contains the personal portfolio link and portfolio screenshot.

task-3-platforms/ Contains the Google Form link, form screenshot, and Google Sheet response screenshot.

task-4-email-etiquette/ Contains the internship inquiry email and the social media do’s and don’ts checklist.

task-5-cybercrime/ Contains files related to cybercrime awareness.
...
Task 3 – Google Workspace Collaboration, Link - 
